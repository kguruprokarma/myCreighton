...
const ClassesApi = {
  ...
  getClassesDataByWeek: () => axios.get(`${urlConstants.DEV_URL_CREIGHTON_ADFS}${urlConstants.STUDENT_CLASSES}`, {withCredentials: true}),
  getClassDetails: () => axios.get(urlConstants.DEV_URL_CREIGHTON_ADFS + urlConstants.CLASS_DETAILS_DATA, {withCredentials: true}),
  getAssignmentDetails: () => axios.get(`${urlConstants.DEV_URL_CREIGHTON_ADFS}${urlConstants.ASSIGNMENTS}`, {withCredentials: true})
