...
const userDetail = ( userDetailProps ) => {
  const userAvatar = userDetailProps.userDetail && userDetailProps.userDetail.legal_name && `${userDetailProps.userDetail.legal_name.first_name.replace(/ /g, '')} ${userDetailProps.userDetail.legal_name.last_name.replace(/ /g, '')}`;
  return (
