...
class SchoolAndSemester extends React.PureComponent {
  ...
  setStateAccordions() {
    ...
    // createAndSendLogs('info', 'setStateAccordions', 'School and Semester', JSON.stringify(tempArray));
  ...
  showAllDesc() {
    // createAndSendLogs('info', 'showAllDesc', 'School and Semester', this.state.descToggle);
  ...
  navigateOnClick(val) {
    // createAndSendLogs('info', 'navigateOnClick', 'School and Semester', val);
  ...
  showAllAccordions() {
    // createAndSendLogs('info', 'showAllAccordions', 'School and Semester', this.state.accordToggle);
  ...
  accordToggleFunc(accordObj) {
    // createAndSendLogs('info', 'accordToggleFunc', 'School and Semester', JSON.stringify(accordObj));
