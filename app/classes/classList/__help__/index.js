          ...
          <nav id='navigation01' className='container'>
            <div className='row'>
              <div className='pull-left ml15 mr0 hidden-lg hamburgerMenu position-relative'>
                <button className='btn btn-link glyphicon glyphicon-menu-left popupBackBtn p0' aria-hidden='true' />
              ...
              <div className='pull-right icons-list col-lg-2 col-sm-3 col-xs-3'>
                <ul className='pull-right list-inline mobile-no-wrap mb0'>
                  ...
                  <li className='head-Icons'>
                    <div className='popUp'>
                      <icon className='glyphicon glyphicon-user btnnoPadding' role='link' tabIndex='0' aria-label='Link to User Profile popup' aria-hidden='true' />
            ...
            <div className='row'>
              <div className='hidden-xs col-md-8 col-sm-6 col-xs-12'>
                <div className='hidden-xs'>
                  <h1 className='bebasregular headerLabel mt5 mb20'>{translateText('common:CLASS_SCHEDULE')}</h1>
                </div>
              </div>
              <div className='controller-buttons classListButtons col-md-4 col-sm-6 col-xs-12'>
                <nav id='navigation03' className='btn-group btn-group-justified form-group openSansRegular help-tabs fs0pt86'><a className='btn btn-default' href='#/classes/today'>Today</a><a className='btn btn-default active' href='#/classes/week'>Week</a><a className='btn btn-default' href='#/classes/list'>A-Z</a></nav>
