  ...
  return (
    <article className='profileRow mt30'>
      ...
      <Row className='show-grid pt5 pb5'>
        ...
        <Col xs={8} md={9} sm={8} className='dataField'><a href={tel} className='mobileNumber'>{emergencyProps.phone}</a></Col>
      </Row>
      <BasicRow displayName={translateText('common:PROFILE_RELATIONSHIP')} displayValue={emergencyProps.relation} />
    </article>
  );
};
