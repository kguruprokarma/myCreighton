...
const Email = (emailProps) => (
  <article className='profileRow mt30'>
    ...
    <Row className='show-grid pt5 pb5'>
      <Col xs={4} md={3} sm={4} className='labelField openSansLight'><label htmlFor='Profile School'>{emailProps.professionalLabel /*translateText('common:PROFILE_SCHOOL') */ }</label> </Col>
      <Col xs={8} md={9} sm={8} className='dataField emailAddress wordBreak'>
        {/* Mailto added for open mail box popup */}
        <Mailto email={emailProps.professionalEmail}>{emailProps.professionalEmail}</Mailto>
      </Col>
    </Row>
    ...
    <Row className='show-grid pt5 pb5'>
      ...
      <Col xs={8} md={9} sm={8} className='dataField emailAddress wordBreak'>
        {/* Mailto added for open mail box popup */}
        <Mailto email={emailProps.personalEmail}>{emailProps.personalEmail}</Mailto>
      </Col>
    </Row>}
  </article>
);
