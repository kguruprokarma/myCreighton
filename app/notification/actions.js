...
const receiveNotifications = (notificationsData) => (
  {
...
export function setNewNotifications() {
  return function (dispatch) {
    dispatch(setNewNotificationData());
  };
}

export function updateNotifications(data) {
  return function (dispatch) {
    dispatch(receiveNotifications({data: data}));
  };
}