...
describe(' SearchBox component testing for campus directory search ----->', () => {
  ...
  HTMLElement.prototype.scrollIntoView = jest.fn(( ) => true);
 ...
 it('Campus Directory keydown functionlaity', () => {
    ...
    expect(searchBox.instance().state.searchText).toBe('f771071ca5, f36b80d347');
    searchBox.find('FormControl').simulate('keyDown', {
      keyCode: 38,
      which: 38,
      preventDefault() {}
    });
    expect(searchBox.instance().state.searchText).toBe('f79979bf40, fc1a98b34b');
    searchBox.find('FormControl').simulate('keyDown', {
      keyCode: 38,
      which: 38,
      preventDefault() {}
    });
    expect(searchBox.instance().state.searchText).toBe('f79979bf40, f3c7769dd4');
    searchBox.find('FormControl').simulate('keyDown', {
      keyCode: 38,
      which: 38,
      preventDefault() {}
    });
    expect(searchBox.instance().state.searchText).toBe('f79979bf40, f089eaef57');
    searchBox.find('FormControl').simulate('keyDown', {
      keyCode: 38,
      which: 38,
      preventDefault() {}
