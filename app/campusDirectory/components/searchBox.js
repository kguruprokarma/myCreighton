          ...
          <Col xs={12}>
            <Form>
              <Row>
                ...
                <Col xs={12} sm={6}>
                  <FormGroup>
                    <FormControl type='search' autoFocus value={this.state.searchText} onKeyPress={this.handleKeyPress} onChange={this.handleChange} className='openSansLight cmpsDirSearch mt20' placeholder={translateText('common:SEARCH_CREIGHTON_STAFF')} />
                ...
                <Col xs={12} sm={3}>
                  <FormGroup>                   
                    <Link onClick={this.onSearchText} disabled={this.state.searchText === '' ? true : false} className='form-control openSansLight cmpsDirSearchBtn mt20 pl10'>{translateText('common:SEARCH')}</Link> 
                  </FormGroup>
                </Col>
              </Row>
            </Form>
