...
const CampusDirectoryTabController = () => (
  <div className='btn-group btn-group-justified form-group openSansRegular fs0pt86'>
    <Link to={ROUTE_URL.CAMPUSDIRECTORY + ROUTE_URL.SIMPLE_SEARCH} className='btn' activeClassName='active'>{translateText('common:SIMPLE_SEARCH')}</Link>
