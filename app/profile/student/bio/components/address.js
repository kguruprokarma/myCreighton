...
const Address = (addressProps) => (
  <article className='profileRow mt30'>
    ...
    <BasicRow displayName={translateText('common:PROFILE_CITY')} displayValue={addressProps.schoolAddress.SPRADDR_CITY} />
    <BasicRow displayName={translateText('common:PROFILE_STATE')} displayValue={addressProps.schoolAddress.SPRADDR_STATE} />
    <BasicRow displayName={translateText('common:PROFILE_ZIP_CODE')} displayValue={addressProps.schoolAddress.SPRADDR_ZIP} />
  </article>
);
