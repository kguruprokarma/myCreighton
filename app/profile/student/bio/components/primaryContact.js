  ...
  return (
    <article className='profileRow mt30 emailAddress'>
      ...
      <Row className='show-grid pt5 pb5'>
        ...
        <Col xs={8} md={9} sm={8} className='dataField'><a href={primaryContactProps.primaryContact ? `tel:${telephoneCheck(primaryContactProps.primaryContact)}` : ''} className='mobileNumber'>{primaryContactProps.primaryContact ? telephoneCheck(primaryContactProps.primaryContact) : ''}</a></Col>
      </Row>
    </article>
  );
};
