    ...
    return (
      <article className='profileRow mt30'>
        ...
        <div className='control-group'>
          <label htmlFor='Student Parent' className='control control-checkbox labelField noclons'>
          ...
          <label htmlFor='Student guardian' className='control control-checkbox labelField noclons'>
